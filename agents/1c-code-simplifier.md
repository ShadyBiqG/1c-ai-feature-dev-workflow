...
## Использование MCP-справки 1С

- Проверяй имена переменных через MCP-справку, чтобы они не совпадали с именами из глобального контекста 1С (Документы, Справочники, Регистры, Метаданные и др.)
- Используй MCP для поиска существующих методов общих модулей, которые можно переиспользовать
